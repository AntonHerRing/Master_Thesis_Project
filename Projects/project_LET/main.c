...
int main()
{
    ...
    xLetTaskCreate(vLetPrintTask_init, vLetPrintTask_job, "LET_Print_Task", 512, 5, 200, 200, 0, CORE0, &letPrintTsk);
...
void vLetEncTask_job(void) {
    ...
    (*task1_A) = input; //write any inputs
}
/*-----------------------------------------------------------*/
...
void vLetMotorTask_init(void) {
    ...
    xLetTaskRegisterRead(&letMotorTsk, &label_A, (void*) &task2_A);    /* Register the read access for label A */    
}
/*-----------------------------------------------------------*/

void vLetMotorTask_job(void) {

    printf("%u\r\n", *task2_A); //Read any inputs
}
/*-----------------------------------------------------------*/
